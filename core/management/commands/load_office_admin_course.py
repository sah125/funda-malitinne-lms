                ...
                if kt.get('quiz_questions'):
                    ...
                    if quiz_created:
                        ...
                        for idx, q in enumerate(kt['quiz_questions'], start=1):
                            ...
                            self.stdout.write(f"         Added question {idx}")

        # ------------------------------
        # 5. Add Practical Assignments
        # ------------------------------
        assignments_data = [
            {'title': 'Practical Assignment: Create a trip itinerary',
             'description': 'Prepare a detailed travel itinerary for a business trip...', 'due_days': 30, 'points': 100},
            {'title': 'Practical Assignment: Organise a meeting',
             'description': 'Plan and document a formal meeting...', 'due_days': 45, 'points': 100},
            {'title': 'Practical Assignment: Develop a Workplace Skills Plan (WSP)',
             'description': 'Using provided training data, complete a WSP template...', 'due_days': 60, 'points': 100},
            {'title': 'Summative Portfolio of Evidence (POE)',
             'description': 'Compile all formative assessments, workplace logbooks, and practical assignments...', 'due_days': 120, 'points': 200},
        ]
